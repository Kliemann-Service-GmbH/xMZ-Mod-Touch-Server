...
impl FromStr for ServerCommand {
    ...
    fn from_str(s: &str) -> Result<ServerCommand, ServerCommandError> {
        ...
        match v[0] {
            ...
            "led" if v.len() == 3
            && (v[1] == "set" || v[1] == "toggle" || v[1] == "clear" ) => Ok( // set || toggle || clear
                ServerCommand::Led {
                    subcommand: String::from(v[1]),
...
mod tests {
    ...
    #[test]
    fn led() {
        let cmd_get     = ServerCommand::from_str("led get");
        ...
        assert_eq!(cmd_get,     Ok(ServerCommand::Led{ subcommand: "get".to_string(), params: None }));
    ...
    #[test]
    fn relais() {
        let cmd_get     = ServerCommand::from_str("relais get");
        ...
        assert_eq!(cmd_get,     Ok(ServerCommand::Relais{ subcommand: "get".to_string(), params: None }));
    ...
    fn relais_invalid() {
        ...
        let cmd_invalid_get     = ServerCommand::from_str("relais get bar");
        ...
        assert_eq!(cmd_invalid_sub,     Err(ServerCommandError::InvalidCommand));
        assert_eq!(cmd_invalid_param,   Err(ServerCommandError::InvalidCommand));
        assert_eq!(cmd_invalid_get,     Err(ServerCommandError::InvalidCommand));
